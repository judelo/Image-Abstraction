...
public:
    ...
    ~TreeOfShapes();
    QImage render(TOSParameters tosParameters, int segmentWithMask, int alternative_model, TreeOfShapes *tosDictionary=NULL, DictionaryParameters dictionaryParameters=getDefaultDictionaryParameters() );
