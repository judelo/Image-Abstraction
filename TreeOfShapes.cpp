...
QImage TreeOfShapes::render(TOSParameters tosParameters, int segmentWithMask, int alternative_model, TreeOfShapes *tosDictionary, DictionaryParameters dictionaryParameters ){
